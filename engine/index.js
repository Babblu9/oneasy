...
function runProjection(input, totalMonths = 72) {
    ...
    return {
        ...
        yearly: {
            pnl: yearlyPnL,
            byStream: revenueData.yearlyByStream,
            byCategory: opexData.yearlyByCategory
        },
        assets: {
            details: depreciationData.assets,
            yearlyTotal: depreciationData.yearlyTotal,
            yearlyAccumulated: depreciationData.yearlyAccumulated,
            yearlyNetBlock: depreciationData.yearlyNetBlock
        },
        summary
    };
}
